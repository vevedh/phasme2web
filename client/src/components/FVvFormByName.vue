    ...
    >
      ...
      <div class="row q-gutter-xl item-center justify-center q-pt-md">
        <q-btn
          ...
          color="primary"
          no-caps
          :label="(saveLabel)?saveLabel:'Enregistrer'"
          type="submit"
        >
...
export default defineComponent({
  ...
  methods: {
    ...
    async setForm(fvalues, fmodel) {
      ...
      const fieldWithDefault = this.fields.filter(o => (o.innerValue && o.innerValue!=''))
    ...
    async updateDisplayForm(fname) {
      ...
      await this.getFormByName(fname);
      this.$q.loading.hide();
      ...
      if (Object(this.formData[0]).hasOwnProperty('titre')) {
        ...
        this.fields = Object.assign([], this.ffields);

        const ffields = Object.assign([], this.ffields);
  ...
  async beforeMount() {
    ...
    console.log('Form Name :', this.nameForm);

...
import qboot_Bootfeathersclient from 'boot/feathers-client'

import qboot_Bootauthnew from 'boot/auth.new'

import qboot_Bootaxios from 'boot/axios'

import qboot_Bootapex from 'boot/apex'

import qboot_Bootjsonviewer from 'boot/jsonviewer'
...
async function start () {
  ...
  const bootFiles = [qboot_Bootcompositionapi,qboot_Bootfeathersclient,qboot_Bootauthnew,qboot_Bootaxios,qboot_Bootapex,qboot_Bootjsonviewer,qboot_Quasarquasarappextensionqcalendarsrcbootregisterjs]

  ...
  <q-layout view="hHh LpR fFf">
    ...
    >
      <q-toolbar >
        ...
        <q-toolbar-title>
          ...
          Registre Visiteurs de la CACEM
    ...
    >
      ...
      >
        ...
        <div
          class="col-9 q-gutter-sm q-pt-xs"
          v-if="!miniState"
        >
              ...
              >
                ...
                >
                  <q-card>
                    ...
                    <q-card-actions>
                      <q-btn color="primary" class="text-white" @click="saveSettings">Mémoriser</q-btn>
                    </q-card-actions>
                  </q-card>
                </q-expansion-item>
  ...
  data () {
    ...
    return {
      ...
      links: {
        Formulaires: {
          routes: [
            { route: '/', faIcon: 'fa fa-home', materialIcon: 'home', name: 'Registre' }
          ],
          show: true
        },
        Vues: {
  ...
  methods: {
    ...
    async saveSettings () {
      await this.writeConfig({
        bgright: (this.col_bgright!='')?this.col_bgright:this.fconfig.bgright,
        profile: (this.col_profile!='')?this.col_profile:this.fconfig.profile,

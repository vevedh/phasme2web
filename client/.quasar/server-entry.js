...
import qboot_Bootfeathersserver from 'boot/feathers-server'
...
export default context => {
  return new Promise(async (resolve, reject) => {
    ...
    const bootFiles = [qboot_Bootcompositionapi,qboot_Bootfeathersserver,qboot_Bootauthnew,qboot_Bootaxios,qboot_Quasarquasarappextensionqcalendarsrcbootregisterjs]

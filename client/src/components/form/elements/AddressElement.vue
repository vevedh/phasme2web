<template>
  <div class="q-px-sm q-form-address q-form-builder-element" >
    ...
    <div class="row" v-if="hint">
      <div class="col-12 text-caption  text-italic q-pa-none" v-html="hint"></div>
    </div>
  </div>
</template>
...
import countryList from '../srcdata/countries.json'

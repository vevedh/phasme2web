<template>
  <div class="q-px-sm q-form-terms q-form-builder-element" >
    <div class="col">
      ...
      <q-checkbox v-model="iAgree" :ref="id" true-value="I Agree" :false-value="false" keep-color :color="hasError ? 'red' : ''"><span :class="hasError ? 'text-negative' : ''">J'accepte </span></q-checkbox>
      <p class="text-negative text-caption  text-italic q-pa-none" v-for="(error, idx) in errors" :key="idx">{{ error }}</p>
    </div>
  </div>
</template>
